...
namespace HKMonitor
{
    ...
    public static class PlayClass
    {
        ...
        public static string Play(string url, int width, int height)
        {
            ...
            if (strTmp.EndsWith(".wmv") || strTmp.EndsWith(".mp4") || strTmp.EndsWith(".wma") || strTmp.EndsWith(".avi") || strTmp.EndsWith(".asf") || strTmp.EndsWith(".mpg"))
            {
            ...
            else if (strTmp.EndsWith(".pdf"))
            {
                return pdf(url,width,height);
            }
            else
            {
                return "无可用工艺资料文件";
        ...
        private static string wmv(string url, int width, int height)
        {
            ...
            //sb.Append("</object><br>\n");
            sb.Append("<embed src=\"" + url + "\" width=\"" + width + "\" height=\"" + height + "\" allowfullscreen=\"true\" loop=\"true\" autostart=\"true\"></>");
            return sb.ToString();
        }
        ...
        private static string pdf(string url, int width, int height)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
            //sb.Append("<object classid=\"clsid:CA8A9780-280D-11CF-A24D-444553540000\" id=\"Pdf1\" width=\"" + width + "\" height=\"" + height + "\">  ");
            //sb.Append("<param name=\"_Version\" value=\"327680\">");
            //sb.Append("<param name=\"_ExtentX\" value=\"19315\"> ");
            //sb.Append("<param name=\"_ExtentY\" value=\"16034\"> ");
            //sb.Append("<param name=\"_StockProps\" value=\"0\"> ");
            //sb.Append("<param name=\"SRC\" value=\"" + url + "\"> ");

            //sb.Append("</object>");
            sb.Append("<embed src=\"" + url + "\" width=\"" + width + "\" height=\"" + height + "\" >");//
            return sb.ToString();
        }
    }
}